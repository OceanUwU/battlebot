...
module.exports = {
    ...
    async execute(interaction) {
        ...
        await interaction.reply({content: `<@${details.user}> pre-registered for the next game. The next time a game is created in this channel, they\'ll automatically join it.`, allowedMentions: []});
    }
};